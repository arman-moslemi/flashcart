...
<View style={styles.parent}>
        ...
        <View style={styles.loginView}>
          ...
          <Input  isIconLeft={"phone-android"} keyboardType={"numeric"}  placeholder="شماره تماس خود را وارد نمایید" containerStyle={styles.textInputLogin} onChangeText={(ss)=>setMobile(ss)} />
